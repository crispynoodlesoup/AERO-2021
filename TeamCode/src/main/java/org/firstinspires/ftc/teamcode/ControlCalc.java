...
public class ControlCalc {
    ...
    public void initDrive(HardwareMecanumbot robot) {
        myRobot = robot;
        myRobot.updateEncoderValues();
        myRobot.resetAngle();
    }
    
    public void calcTurnPower(double target) {
        // calculate derivative using previous values
        ...
        // PID coming together...
        //turnP = angleP + angleI + angleD;
        
        // comments for PID tuning purposes
        //turnP = angleP;
        turnP = angleP + 5*angleD;
        
        // clip turnP and get rid of the noise of motors screaming 
