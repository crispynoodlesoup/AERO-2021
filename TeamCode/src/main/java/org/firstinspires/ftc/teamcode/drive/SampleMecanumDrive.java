...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(1, 0.5, 0.5);
    ...
    public Servo dropPlate, clamp, cap, rightClaw, leftClaw;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        dropPlate   = hardwareMap.get(Servo.class,   "drop_plate");
        clamp       = hardwareMap.get(Servo.class,   "clamp");
        rightClaw   = hardwareMap.get(Servo.class,   "right_claw");
        leftClaw    = hardwareMap.get(Servo.class,   "left_claw");

        colorLeft = hardwareMap.get(ColorSensor.class, "color_left");
    ...
    public boolean slidePositionToPower(double position) {
        if(getSlidePosition() > position + 0.02) {
            slides.setPower(0.2);
            return true;
        }
    ...
    //public void slidePowerByTime

    public void colorSenseLeft() {
        while(colorLeft.green() < 30) {
